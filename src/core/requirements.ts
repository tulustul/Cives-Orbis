...
export class CityNeedDistrictRequirementImpl
  implements IRequirement<CityNeedDistrictRequirement>
{
  constructor(public options: CityNeedDistrictRequirement) {}
...
> = {
  ...
  "city.needDistrict": CityNeedDistrictRequirementImpl,
};
